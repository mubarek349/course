...
function EnglishCertification({
  ...
  return (
    <div
      ...
      className="w-full h-full text-[#1f2937] p-0 print:p-0 overflow-auto"
    >
      ...
      <div className="w-full h-full flex justify-center items-start p-4 overflow-auto ">
        <div className="w-full max-w-5xl min-w-0">
          ...
          <div
            ref={ref}
            className="relative bg-white shadow-2xl rounded-[24px] min-w-0 w-full overflow-auto border-8 border-[#e9d8a6] print:shadow-none print:border-0"
          >
              ...
              <div className="mt-10 grid grid-cols-3 gap-8 max-w-3xl mx-auto items-end">
                ...
                <div className="text-right">
                  <Image
                    ...
                    width={180}
                    height={120}
                    className="Absolute h-40 object-contain mb-2 ml-auto opacity-90"
                  />
                  <div className="h-px bg-slate-300 mb-1" />
...
function AmharicCertification({
  ...
  return (
    <div
      id="certificate-print"
      className="w-full h-full text-[#1f2937] p-0 print:p-0 overflow-x-auto overflow-y-auto"
    >
      {/* Hide everything except the certificate on print */}
      <style jsx global>{`
        @media print {
      ...
      <div className="w-full h-full flex justify-center items-start p-4 overflow-x-auto overflow-y-auto">
        <div className="w-full max-w-5xl min-w-0">
          <div className="flex items-center justify-between mb-4 print:hidden">
            <button
              onClick={onBack}
